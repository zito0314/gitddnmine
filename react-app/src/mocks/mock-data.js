...
const mockData = {
  ...
  "commits": [
    ...
    },
    {
      ...
      "sha": "e7d22a45",
      "repositoryId": "mobile-banking-api",
      "title": "결제 승인 API 예외 처리 개선",
      "description": "결제 승인 응답 코드와 예외 케이스 처리를 보완했습니다.",
      "author": "김신한",
      "createdAt": "1시간 전",
      "date": "2026.05.28",
      "added": 88,
      "removed": 14,
      "branch": "feature/payment-exception",
      "tag": "v1.2.0",
      "pipelineStatus": "passed",
      "mrId": 129,
      "changedFiles": 5
    },
    {
      ...
      "sha": "b9f3c812",
      "repositoryId": "mobile-banking-api",
      "title": "세션 만료 응답 코드 표준화",
      "description": "세션 만료 시 반환되는 응답 코드를 표준화했습니다.",
      "author": "Min",
      "createdAt": "3시간 전",
      "date": "2026.05.28",
      "added": 47,
    ...
    },
    {
      ...
      "sha": "6d2a7f0e",
      "repositoryId": "mobile-banking-api",
      "title": "보안 점검 리포트 화면 연동",
      "description": "보안 점검 결과 리포트를 Commit 상세 화면과 연동했습니다.",
      "author": "Yoon",
      "createdAt": "어제",
      "date": "2026.05.27",
      "added": 63,
    ...
    },
    {
      ...
      "sha": "4c8e1b97",
      "repositoryId": "mobile-banking-api",
      "title": "푸시 알림 재시도 로직 보완",
      "description": "푸시 알림 전송 실패 시 재시도 로직을 보완했습니다.",
      "author": "Han",
      "createdAt": "2일 전",
      "date": "2026.05.26",
      "added": 102,
    ...
    },
    {
      ...
      "sha": "2f5b6ec3",
      "repositoryId": "mobile-banking-api",
      "title": "운영 배포 전 점검 항목 추가",
      "description": "운영 배포 전 확인이 필요한 점검 항목을 추가했습니다.",
      "author": "김신한",
      "createdAt": "2일 전",
      "date": "2026.05.26",
      "added": 38,
  ...
  "fileSystem": {
    "mobile-banking-api": {
      "branches": ["dev", "main", "develop", "feature/auth-banner"],
      "defaultBranch": "dev",
      "files": [
        {
          "path": "folder1/folder2/folder3/folder4/page.tsx",
          "name": "page.tsx",
          "type": "file",
          "commitMessage": "Refactor: page layout 정리",
          "author": "Min",
          "updatedAt": "1시간 전",
          "status": "passed",
          "version": "3.4",
          ...
          "codeLines": [
            ...
            "",
            "  if (loading) return <PageLayout.Skeleton />",
            "",
            "  return (",
            "    <PageLayout title=\"Files\">",
            "      <PageLayout.Tree data={tree} />",
            "    </PageLayout>",
            "  )",
            "}"
          ]
        ...
        {
          "path": "folder1/folder2/folder3/README.md",
          "name": "README.md",
          "type": "file",
          "commitMessage": "Docs: 모듈 설명 추가",
          "author": "Yoon",
          "updatedAt": "어제",
          "status": "passed",
          "version": "3.3",
          ...
          "codeLines": [
            ...
            "## 사용",
            "",
            "각 파일은 Commit 메타 정보와 함께 표시됩니다."
          ]
        },
        {
          "path": "folder1/folder2/folder3/file1",
          "name": "file1",
          "type": "file",
          "commitMessage": "Update: style.css",
          "author": "김동현",
          "updatedAt": "2시간 전",
          "status": "failed",
          "version": "3.4",
        ...
        {
          "path": "folder1/folder2/app.config.js",
          "name": "app.config.js",
          "type": "file",
          "commitMessage": "Chore: 빌드 설정 업데이트",
          "author": "Han",
          "updatedAt": "2일 전",
          "status": "passed",
          "version": "3.2",
        ...
        {
          "path": "src/api/pipelines.js",
          "name": "pipelines.js",
          "type": "file",
          "commitMessage": "Fix: Pipeline 상태 매핑 보완",
          "author": "Yoon",
          "updatedAt": "어제",
          "status": "running",
          "version": "3.4",
          ...
          "codeLines": [
            ...
            "",
            "export function getPipelines(repositoryId) {",
            "  return request(`/repositories/${repositoryId}/pipelines`)",
            "}",
            "",
            ...
            "  return request(`/pipelines/${pipelineId}/retry`, { method: 'POST' })",
            "}"
          ]
        },
        {
          ...
          "codeLines": [
            ...
            "}",
            "",
            "export function normalizePolicyResponse(response: PolicyResponse) {",
            "  if (response.status === 'blocked') return { status: 'blocked' }",
            "  if (!response.policy) return { status: 'review' }",
            "  return response",
            "}"
          ]
        },
        {
          "path": "src/pages/PipelineDetail.jsx",
          "name": "PipelineDetail.jsx",
          "type": "file",
          "commitMessage": "Pipeline 상세 화면 정리",
          "author": "Min",
          "updatedAt": "3시간 전",
          "status": "passed",
          "version": "3.4",
          ...
          "codeLines": [
            ...
            "",
            "  return (",
            "    <Card title={`Pipeline #${pipelineId}`}>",
  ...
  "audit": {
    ...
    "auditLogs": [
      {
        "id": "AU-2026-001",
        "time": "2026-05-30 22:00",
        "target": "인증 정책 개선",
        "repositoryName": "mobile-banking-api",
        "mergeRequestId": 123,
        "mergeRequestTitle": "feat: Update file style.css",
        "requester": "김신한",
        "branch": "feature/login-policy → develop",
        "trigger": "MR 승인",
        "pipelineStatus": "passed",
      ...
      {
        "id": "AU-2026-002",
        "time": "2026-05-30 21:34",
        "target": "Repository 정책 변경",
        "repositoryName": "auth-policy-engine",
        "mergeRequestId": 124,
        "mergeRequestTitle": "fix: role matcher condition",
        "requester": "박보안",
        "branch": "feature/rule-matcher → develop",
        "trigger": "Policy 변경",
        "pipelineStatus": "failed",
      ...
      {
        "id": "AU-2026-003",
        "time": "2026-05-30 20:12",
        "target": "보안 검증 차단",
        "repositoryName": "customer-web-portal",
        "mergeRequestId": 126,
        "mergeRequestTitle": "feat: account cache refresh",
        "requester": "민프론트",
        "branch": "feature/account-cache → develop",
        "trigger": "Security Validation",
        "pipelineStatus": "running",
        "deploymentStatus": "none",
        "policyStatus": "risk_required",
        "ip": "10.32.44.72"
      },
      {
        "id": "AU-2026-004",
        ...
        "mergeRequestId": 120,
        "mergeRequestTitle": "feat: retry policy",
        "requester": "최운영",
        "branch": "feature/retry-policy → main",
        "trigger": "Deployment",
        "pipelineStatus": "passed",
      ...
      {
        "id": "AU-2026-005",
        "time": "2026-05-29 17:48",
        "target": "Pipeline 재실행",
        "repositoryName": "admin-console-ui",
        "mergeRequestId": 114,
        "mergeRequestTitle": "feat: role badge",
        "requester": "임프론트",
        "branch": "feature/role-badge → develop",
        "trigger": "Pipeline",
        "pipelineStatus": "failed",
      ...
      {
        "id": "AU-2026-006",
        "time": "2026-05-29 15:21",
        "target": "MR 리뷰 승인",
        "repositoryName": "notification-gateway",
        "mergeRequestId": 125,
        "mergeRequestTitle": "feat: template variables",
        "requester": "윤데브옵스",
        "branch": "feature/template-vars → develop",
        "trigger": "Review",
        "pipelineStatus": "passed",
      ...
      {
        "id": "AU-2026-007",
        "time": "2026-05-28 13:10",
        "target": "Branch 보호 정책 적용",
        "repositoryName": "mobile-banking-api",
        "mergeRequestId": 117,
        "mergeRequestTitle": "feat: terms response",
        "requester": "한백엔드",
        "branch": "feature/terms-response → develop",
      ...
      {
        "id": "AU-2026-008",
        "time": "2026-05-27 10:44",
        "target": "권한 매핑 변경",
        "repositoryName": "auth-policy-engine",
        "mergeRequestId": 111,
        "mergeRequestTitle": "feat: role import",
        "requester": "백감사",
        "branch": "feature/role-import → main",
      ...
      },
      {
        ...
        "target": "외부 모듈 교체 검토",
        "repositoryName": "partner-payment-sdk",
        "mergeRequestId": 118,
        "mergeRequestTitle": "feat: external auth module",
        "requester": "Partner Dev",
        "branch": "feature/external-auth → develop",
      ...
      {
        "id": "AU-2026-010",
        "time": "2026-05-25 22:20",
        "target": "감사 로그 Export",
        "repositoryName": "compliance-exporter",
        "mergeRequestId": 119,
        "mergeRequestTitle": "feat: audit export format",
        "requester": "백감사",
        "branch": "feature/audit-export → develop",
      ...
      {
        "id": "AU-2026-011",
        "time": "2026-05-24 18:16",
        "target": "대출 화면 변경 승인",
        "repositoryName": "loan-screen-web",
        "mergeRequestId": 122,
        "mergeRequestTitle": "feat: loan status card",
        "requester": "서QA",
        "branch": "feature/loan-status-card → develop",
        "trigger": "Approval",
        "pipelineStatus": "passed",
      ...
      {
        "id": "AU-2026-012",
        "time": "2026-05-23 16:55",
        "target": "정산 파일 암호화 검토",
        "repositoryName": "settlement-batch",
        "mergeRequestId": 112,
        "mergeRequestTitle": "feat: encrypt export",
        "requester": "최운영",
        "branch": "feature/encrypt-export → develop",
    ...
    "tags": [
      {
        ...
        "commitSha": "c2b8e129",
        "commitMessage": "다음 버전 릴리즈 후보",
        "author": "Min",
        "updatedAt": "2026-05-28T15:00:00+09:00",
        "protected": false,
        "release": false,
        "isProtected": false,
        "isRelease": false,
        "type": "pre-release",
        "releaseNote": "다음 버전 릴리즈 후보",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "91a42df0",
        "commitMessage": "운영 배포 승인 태그",
        "author": "Choi",
        "updatedAt": "2026-05-27T10:00:00+09:00",
        "protected": true,
        "release": true,
        "isProtected": true,
        "isRelease": true,
        "type": "production",
        "releaseNote": "운영 배포 승인 태그",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "91a42df0",
        "commitMessage": "5월 정기 릴리즈 후보",
        "author": "Choi",
        "updatedAt": "2026-05-27T09:20:00+09:00",
        "protected": true,
        "release": true,
        "isProtected": true,
        "isRelease": true,
        "type": "release",
        "releaseNote": "5월 정기 릴리즈 후보",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "7e14d754",
        "commitMessage": "인증 정책 응답값 개선 정식 배포",
        "author": "Choi",
        "updatedAt": "2026-05-26T14:10:00+09:00",
        "protected": true,
        "release": true,
        "isProtected": true,
        "isRelease": true,
        "type": "production",
        "releaseNote": "인증 정책 응답값 개선 정식 배포",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "5c91a022",
        "commitMessage": "Pipeline retry hotfix",
        "author": "Yoon",
        "updatedAt": "2026-05-23T11:30:00+09:00",
        "protected": false,
        "release": false,
        "isProtected": false,
        "isRelease": false,
        "type": "hotfix",
        "releaseNote": "Pipeline retry hotfix",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "c2b8e129",
        "commitMessage": "고객 포털 인증 배너 개선 배포",
        "author": "Min",
        "updatedAt": "2026-05-28T17:50:00+09:00",
        "protected": true,
        "release": true,
        "isProtected": true,
        "isRelease": true,
        "type": "production",
        "releaseNote": "고객 포털 인증 배너 개선 배포",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "commitSha": "4ac81e02",
        "commitMessage": "로그인 만료 처리 긴급 수정",
        "author": "Park",
        "updatedAt": "2026-05-25T13:00:00+09:00",
        "protected": false,
        "release": false,
        "isProtected": false,
        "isRelease": false,
        "type": "hotfix",
        "releaseNote": "로그인 만료 처리 긴급 수정",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
      ...
      },
      {
        ...
        "organizationName": "디지털뱅킹개발팀",
        "name": "v1.3.9",
        "description": "모바일 인증 안정화 태그",
        "commitSha": "2a7d91bc",
        "commitMessage": "모바일 인증 안정화 태그",
        "author": "Jito",
        "updatedAt": "2026-05-20T17:40:00+09:00",
        "protected": false,
        "release": false,
        "isProtected": false,
        "isRelease": false,
        "type": "tag",
        "releaseNote": "모바일 인증 안정화 태그",
        "sourceDownloadFormats": ["zip", "tar.gz", "tar.bz2", "tar"],
        "latestCommit": { "sha": "2a7d91bc", "message": "모바일 인증 안정화 태그", "author": "Jito", "updatedAt": "2026-05-20", "updatedAtText": "8일 전 마지막 업데이트" },
        "createdAt": "2026-05-20",
        "createdAtText": "8일 전 생성"
      }
    ]
  }
}
