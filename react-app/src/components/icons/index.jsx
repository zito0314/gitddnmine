...
import bookOutlinedSvg from './svg/BookOutlined.svg?raw'
...
import circleDotOutlinedSvg from './svg/CircleDotOutlined.svg?raw'
import clipboardListOutlinedSvg from './svg/ClipboardListOutlined.svg?raw'
...
import fileListOutlinedSvg from './svg/FileListOutlined.svg?raw'
...
import goBackOutlinedSvg from './svg/GoBackOutlined.svg?raw'
...
import listFilterOutlinedSvg from './svg/ListFilterOutlined.svg?raw'
import lockOutlinedSvg from './svg/LockOutlined.svg?raw'
import mailOutlinedSvg from './svg/MailOutlined.svg?raw'
import mapOutlinedSvg from './svg/MapOutlined.svg?raw'
import menuFoldOutlinedSvg from './svg/MenuFoldOutlined.svg?raw'
import menuTreeOutlinedSvg from './svg/MenuTreeOutlined.svg?raw'
import menuUnfoldOutlinedSvg from './svg/MenuUnfoldOutlined.svg?raw'
import mergeRequestOutlinedSvg from './svg/MergeRequestOutlined.svg?raw'
...
import shieldOutlinedSvg from './svg/ShieldOutlined.svg?raw'
import squareMousePointerOutlinedSvg from './svg/SquareMousePointerOutlined.svg?raw'
...
import testTubeDiagonalOutlinedSvg from './svg/TestTubeDiagonalOutlined.svg?raw'
import timerCircleOutlinedSvg from './svg/TimerCircleOutlined.svg?raw'
import timerOutlinedSvg from './svg/TimerOutlined.svg?raw'
import toolOutlinedSvg from './svg/ToolOutlined.svg?raw'
import uploadOutlinedSvg from './svg/UploadOutlined.svg?raw'
import userCheckOutlinedSvg from './svg/UserCheckOutlined.svg?raw'
...
export const BookOutlined = createIcon(bookOutlinedSvg)
...
export const CircleDotOutlined = createIcon(circleDotOutlinedSvg)
export const ClipboardListOutlined = createIcon(clipboardListOutlinedSvg)
...
export const FileListOutlined = createIcon(fileListOutlinedSvg)
...
export const GoBackOutlined = createIcon(goBackOutlinedSvg)
...
export const ListFilterOutlined = createIcon(listFilterOutlinedSvg)
export const LockOutlined = createIcon(lockOutlinedSvg)
export const MailOutlined = createIcon(mailOutlinedSvg)
export const MapOutlined = createIcon(mapOutlinedSvg)
export const MenuFoldOutlined = createIcon(menuFoldOutlinedSvg)
export const MenuTreeOutlined = createIcon(menuTreeOutlinedSvg)
export const MenuUnfoldOutlined = createIcon(menuUnfoldOutlinedSvg)
export const MergeRequestOutlined = createIcon(mergeRequestOutlinedSvg)
...
export const ShieldOutlined = createIcon(shieldOutlinedSvg)
export const SquareMousePointerOutlined = createIcon(squareMousePointerOutlinedSvg)
...
export const TestTubeDiagonalOutlined = createIcon(testTubeDiagonalOutlinedSvg)
export const TimerCircleOutlined = createIcon(timerCircleOutlinedSvg)
export const TimerOutlined = createIcon(timerOutlinedSvg)
export const ToolOutlined = createIcon(toolOutlinedSvg)
export const UploadOutlined = createIcon(uploadOutlinedSvg)
export const UserCheckOutlined = createIcon(userCheckOutlinedSvg)
