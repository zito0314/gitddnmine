...
export default function RepositoryCreate() {
  ...
  return (
    <Space direction="vertical" size={24} style={{ width: '100%' }} className="repository-request-page">
      <PageHeader
        title="저장소 생성 요청"
          ...
          <Space direction="vertical" size={12}>
            <div>
              ...
              <ol style={{ margin: '8px 0 0 18px', padding: 0 }}>
                <li>요청자가 저장소 정보를 입력하고 생성 요청을 제출합니다.</li>
                <li>관리자가 요청 내용, 저장소명, 템플릿을 검토합니다.</li>
                <li>승인 완료 후, 저장소가 생성되고 멤버에게 접근 권한이 부여됩니다.</li>
              </ol>
            </div>
            <div>
      ...
      <Card>
        ...
        >
          ...
          <SectionIntro
            title="기본 정보"
            description="프로젝트 목적이 잘 드러나도록 저장소 정보를 작성해주세요. 저장소 이름은 영문, 숫자, 밑줄(_), 마침표(.), 더하기(+), 대시(-)를 사용할 수 있어요."
          />
          <Form.Item
            label="저장소 이름"
            name="repositoryName"
